                    ...
                    <div class="p-3 py-5">
                        <div class="row mt-2">
                            <div class="col-md-12">
                                ...
                                <input type="text"  name="title" id="title" class="form-control" placeholder="Enter Name" value="{{$data['row']->title}}">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <label for="desctiption">Description</label>
                                <textarea type="textarea"   name="desctiption" id="desctiption" class="form-control"> {{$data['row']->desctiption}}</textarea>
                            </div>
                            </div>
                        <div>
